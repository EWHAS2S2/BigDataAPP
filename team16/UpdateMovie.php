						...
						<div class="inner">
							...
							<!-- Content -->
								<section>
                                    ...
                                    <form>
                                        <h2>Update Movie Data Result</h2> 
                                    </form>
                                    ...
                                    <?php
                                        ...
                                        $sql = "UPDATE movie_recommend SET title='$_POST[utitle]', vote_average='$_POST[uvote_average]',popularity='$_POST[upopularity]', release_date='$_POST[urelease_date]' WHERE movie_id ='$_POST[umovie_id]' "; // 쿼리
